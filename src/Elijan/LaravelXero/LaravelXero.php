...
class LaravelXero {
     ...
     * goes to NDIA
     */
    public function createInvoiceAccRec(\MePlus\Models\PlanManager $planManager, $reference_id, $status){
     ...
     */
    public function createInvoiceAccPay( $account, $reference_id, $url, $status){
